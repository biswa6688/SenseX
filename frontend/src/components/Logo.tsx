...
export function Logo({ size = 40, animated = false, className = '' }: LogoProps) {
  return (
    ...
    >
      <defs>
        <linearGradient id="intellisense-logo-grad" x1="0" y1="0" x2="48" y2="48">
          <stop offset="0%" stopColor="var(--color-brand)" />
          <stop offset="100%" stopColor="var(--color-brand-2)" />
        </linearGradient>
      </defs>

      <g stroke="url(#intellisense-logo-grad)" strokeWidth="1.5" opacity="0.7">
      ...
      <circle cx="24" cy="24" r="7" fill="url(#intellisense-logo-grad)">
        {animated && (
      ...
      {[
        ...
        <circle key={i} cx={cx} cy={cy} r="3.2" fill="url(#intellisense-logo-grad)">
          {animated && (
            <animate
